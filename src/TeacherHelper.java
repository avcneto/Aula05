...
public class TeacherHelper {
	...
	public static void main(String[] args) {
		...
		//criando um gerador de número aleatorio
		...
		while (opcao != 4) {
			...
			case 1:
				...
				System.out.println("Por favor também informe o valor da hora aula praticado na instituição:");
			...
			case 3:
				...
				case 0:
					System.out.println("Seus alunos da imersão acham que voce tem a autora do Darth vader!");
					break;
				case 1:
